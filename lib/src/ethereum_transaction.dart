...
class EthereumTransaction {
  ...
  static Future<String?> signEthereumTransaction(
    ...
    if (transaction == null) {
      ...
      var credentials = await ethClient.credentialsFromPrivateKey(bytesToHex(privateKey.privateKey));
      Uint8List signedTxhex =
          await ethClient.signTransaction(credentials, transaction.tx);
          String s = bytesToHex(signedTxhex);
      return '0x' + s;
    }
  }
